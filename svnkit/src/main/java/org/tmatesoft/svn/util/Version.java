...
public class Version {
    ...
    private static final String VERSION_STRING_DEFAULT = "SVN/1.8.1 SVNKit/1.8.7 (http://svnkit.com/) rSNAPSHOT";
    ...
    private static final String SVN_VERSION_DEFAULT = "1.8.7";
